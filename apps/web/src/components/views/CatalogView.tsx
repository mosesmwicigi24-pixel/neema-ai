...
function CatalogForm({ form, f, categories }: CatalogFormProps) {
    // showNewCatInput is true whenever the user has chosen "+ New category…" OR
    // has already typed a value that isn't one of the known categories.
    // This means the input stays visible after blur — it only disappears if the
    // user picks an existing category from the select.
    const isKnownCat =
        form.category === "" ||
        form.category === "__new__" ||
        categories.includes(form.category);
    const showNewCatInput = form.category === "__new__" || !isKnownCat;
                ...
                <div>
                    ...
                    {showNewCatInput && (
                        <input
                            ...
                            autoFocus
                            // Write directly to form.category on every keystroke.
                            // showNewCatInput stays true as long as the value isn't
                            // a known category, so the input never unmounts mid-edit.
                            value={
                                form.category === "__new__" ? "" : form.category
                            }
                            onChange={(e) =>
                                f("category", e.target.value || "__new__")
                            }
                        />
                    )}
                </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex flex-col justify-end pb-0.5">
                    <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        >
                            <div
                                className={`w-4 h-4 rounded-full bg-white shadow mt-0.5 transition-transform ${form.in_stock ? "translate-x-4.5 ml-4" : "ml-0.5"}`}
                            />
                        </div>
                        <span className="text-xs text-[#427425] font-medium">
                            In stock
                        </span>
                    </label>
                </div>
        ...
        >
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="p-3">
                                ...
                                <div className="text-[10px] text-[#b5da8b] font-mono mt-2">
                                    {item.sku}
                                </div>
                            </div>
                        </div>
            ...
            >
                ...
                <div className="flex gap-2 mt-4">
                    ...
                    <Btn onClick={() => setAddModal(false)} variant="outline">
                        Cancel
                    </Btn>
                </div>
            </Modal>
            ...
            >
                ...
                <div className="flex gap-2 mt-4">
                    ...
                    <Btn onClick={() => setEditModal(false)} variant="outline">
                        Cancel
                    </Btn>
                </div>
            </Modal>
            ...
            >
                <p className="text-sm text-[#427425] mb-1">
                    ...
                    <span className="font-semibold text-[#16270c]">
                        {delItem?.name}
                    </span>
                    ?
                </p>
                <p className="text-xs text-[#9ccd65] mb-5">
                ...
                <div className="flex gap-2">
                    ...
                    <Btn onClick={() => setDelModal(false)} variant="outline">
                        Cancel
                    </Btn>
                </div>
            </Modal>
